    ...
    <form action="/admin/actualizar/{{ $administradore->id }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="password"
                ...
                value="{{ $administradore->contraseña }}" />
        </div>
        <div class="mb-6">
        ...
        <div class="form-group">
            ...
            <select
                ...
                <option value="superadmin" {{ $administradore->type == 'superadmin' ? 'selected' : '' }}>Superadmin
                </option>
                <option value="admin" {{ $administradore->type == 'admin' ? 'selected' : '' }}>Admin</option>
                <option value="base" {{ $administradore->type == 'base' ? 'selected' : '' }}>Base</option>
            </select>
        </div>
